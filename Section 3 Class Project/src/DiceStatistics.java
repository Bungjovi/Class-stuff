...
import java.util.Scanner;
	...
	public class DiceStatistics {
		...
		public static void main(String[] args) {	
			...
			List<Integer> rolls = new ArrayList<Integer>();// List only works with Reference types
			...
			// initialized outside of loop because if inside loop, variable would initialize to zero everytime.
//			int ones = 0;
//			int twos = 0;
//			int threes = 0;
//			int fours = 0;
