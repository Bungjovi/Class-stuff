...
public class Variables {
	...
	public static void main(String[] args) {
		/*	Primitive Data Types
			------------------------------------
			byte, short, int, long - whole number data types
			float, double - floating point data types ( real numbers )
			char - represents 1 character
			boolean - true/false			
		*/
		...
		int age = 37;
		float num = 0f; // a float has to be declared with a 'f' following the value
		double num2 = 0;
